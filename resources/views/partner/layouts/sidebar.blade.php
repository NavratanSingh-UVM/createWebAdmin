          ...
          <div class="collapse navbar-collapse bg-white" id="primaryMenuSidebar">
             <ul class="list-group list-group-flush w-100 customlisting">
                <li class="list-group-item pt-2 pb-2">
                   <ul class="list-group">
                     <li><a href="{{route('partner.dashboard')}}" @if(Route::current()->getName()=='partner.dashboard') class="active" @endif>Dashboard</a></li>
                   </ul>
                </li>
                <li id="headingTwo">
                  ...
                  <div id="collapseTwo" class="collapse  @if(in_array(Route::current()->getName(),['partner.manage.payment','partner.manage.partner.listing','partner.create.partner.listing','partner.add.partner.listing.payment'])) show @endif" aria-labelledby="headingTwo" data-parent="#accordionExample">
                     <ul class="p-0">
                        {{-- <li><a href="{{ route('partner.manage.payment') }}" @if(in_array(Route::current()->getName(),['partner.manage.payment','partner.add.partner.listing.payment'])) class="active" @endif>Manage Payment</a></li>
                        <li><a href="{{ route('partner.manage.partner.listing') }}" @if(in_array(Route::current()->getName(),['partner.manage.partner.listing','partner.create.partner.listing'])) class="active" @endif>Manage Partner Listing</a></li> --}}
                     </ul>
                  </div>
                </li>
                  <li><a href="{{ route('partner.manage.payment') }}" @if(in_array(Route::current()->getName(),['partner.manage.payment','partner.add.partner.listing.payment'])) class="active" @endif>Manage Payment</a></li>
