                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <span class="description text-danger" id="output"></span>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
    ...
    <script>
       ...
       let images = [];
        ...
        partnerListing.onsubmit = async (e) => {
            ...
            const response = await fetch("{{route('partner.update.partner.listing')}}",{
                method:"POST",
                body:formData,
                headers:{
...
delete_image = (id) =>{
    Swal.fire({
        ...
        if (result.isConfirmed) {
            showLoader();
            $.ajax({
                url: "{{ route('partner.delete.image.partner.listing') }}",
                type: 'POST',
                dataType: "json",
