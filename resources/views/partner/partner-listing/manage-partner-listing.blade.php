        ...
        <div class="row">
            <div class="col-md-12 mb-5">
                <div class="text-right">
                    <a href="{{ route('partner.create.partner.listing') }}" class="btn btn-lg btn-primary next-button property_information" type="button">Create Partner Listing
...
partnerListingDelete = (id) =>{
    Swal.fire({
        ...
        if (result.isConfirmed) {
            showLoader();
            $.ajax({
                url: "{{ route('partner.partner.listing.delete') }}",
                type: 'POST',
                dataType: "json",
