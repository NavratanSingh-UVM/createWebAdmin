        ...
        <div class="content-body">
            <div class="row page-titles mx-0">
                <div class="col p-md-0">
                    ...
                    <div class="row">
                        <div class="col-md-6"><h4 style="color:black">Blog</h4></div>
                        <div class="col-md-6 text-right"><a href="{{ route('admin.blog.create') }}" class="btn mb-1 btn-primary float-right">Add Blog <span class="btn-icon-right"><i class="fa fa-plus"></i></span>
                        </a> </div>                                
                    </div>
                </div>
            </div> 
