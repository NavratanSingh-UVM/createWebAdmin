...
class PropertyListing extends Model
{
    ...
    protected $fillable = [
        'user_id','property_name','property_main_photos','property_type_id','square_feet','bedrooms','sleeps','avg_night_rates','avg_rate_unit','baths','description','country_id','location',
        'state_id','region_id','city_id','address','town','zip_code','currency_id',
        ...
        'status','cancelletion_policies_id'
    ];
