...
var FullCalendar = (function(e) {
    ...
    function U(e, r, i) {
        ...
        n.__ && n.__(e, r),
            ...
            N(
                ...
                o || d,
                d,
                void 0 !== r.ownerSVGElement, !s && i ? [i] :
                o ?
                null :
                r.firstChild ?
                t.call(r.childNodes) :
                null,
                a, !s && i ? i : o ? o.__e : r.firstChild,
                s
            ),
            P(a, e);
    }
    ...
    function Vn(e, t) {
        return {
            ...
            durationEditable: null != t.durationEditable ?
                t.durationEditable : e.durationEditable,
    ...
    function Yn(e, t, n, r, i = Xn(n), s, o) {
        ...
        if (u) {
            ...
            return (
                ...
                e.publicId &&
                o[e.publicId] &&
                (r.instanceId = o[e.publicId]), { def: e, instance: r }
            );
        }
        return null;
    }
    ...
    function tr(e, t = ht(0)) {
        ...
        return (
            e.start && ((n = Lt(e.start)), r && r <= n && (r = Pt(n, 1))), { start: n, end: r }
        );
    }
    ...
    function Cr(e, t, n = "day", r = !0) {
        ...
        if (s.navLinks) {
            ...
            return Object.assign({ title: ot(s.navLinkHint, [a, e], a), "data-navlink": "" },
                r ? Ge(l) : { onClick: l }
            );
        }
        return { "aria-label": a };
    ...
    class Zr extends D {
        shouldComponentUpdate(e, t) {
            return (
                this.debug && console.log(_t(e, this.props), _t(t, this.state)), !Tt(this.props, e, this.propEquality) ||
    ...
    class ei {
        ...
        buildCurrentRangeInfo(e, t) {
            ...
            return (
                ...
                ((i = this.getFallbackDuration()),
                    (s = bt(i).unit),
                    (o = this.buildRangeFromDuration(e, t, i, s))), { duration: i, unit: s, range: o }
            );
        }
        getFallbackDuration() {
            return ht({ day: 1 });
        ...
        adjustActiveRange(e) {
            let {
                ...
                slotMinTime: r,
                slotMaxTime: i,
            } = this.props, { start: s, end: o } = e;
            return (
                n &&
                (mt(r) < 0 && ((s = Lt(s)), (s = t.add(s, r))),
                    mt(i) > 1 &&
                    ((o = Lt(o)), (o = Pt(o, -1)), (o = t.add(o, i)))), { start: s, end: o }
            );
        }
        buildRangeFromDuration(e, t, n, r) {
            let i,
                s,
                o, { dateEnv: a, dateAlignment: l } = this.props;
            if (!l) {
    ...
    class li {
        ...
        setProp(e, t) {
            if (e in Qn)
                ...
                let n = Un[e](t);
                (n =
                    "color" === e ? { backgroundColor: t, borderColor: t } :
                    "editable" === e ? { startEditable: t, durationEditable: t } : {
                        [e]: t
                    }),
    ...
    function bi(e, t) {
        let { pluginHooks: n } = t,
        r = n.isDraggableTransformers, { def: i, ui: s } = e.eventRange,
            o = s.startEditable;
    ...
    function Ai(e, t, n, r, i, s, o) {
        let { dateEnv: a, options: l } = n, { displayEventTime: c, displayEventEnd: d } = l,
        u = e.eventRange.def,
        ...
        if (t) {
            ...
            if (Zt(e)) {
                ...
                return (
                    ...
                    (n =
                        ("-" === t[15] ? -1 : 1) *
                        (60 * Number(t[16] || 0) + Number(t[18] || 0))), { marker: e, isTimeUnspecified: !t[6], timeZoneOffset: n }
                );
            }
        }
        return null;
    ...
    class Bi {
        ...
        createMarkerMeta(e) {
            ...
            return (
                ...
                null !== t && Zt(t) ? { marker: t, isTimeUnspecified: !1, forcedTzo: null } :
                null
            );
        }
        parse(e) {
        ...
        greatestWholeUnit(e, t) {
            ...
            return null !== n ? { unit: "year", value: n } :
                ((n = this.diffWholeMonths(e, t)),
                    null !== n ? { unit: "month", value: n } :
                    ((n = Ut(e, t)),
                        null !== n ? { unit: "week", value: n } :
                        ((n = Wt(e, t)),
                            null !== n ? { unit: "day", value: n } :
                            ((n = (function(e, t) {
                                    return (
                                        (t.valueOf() - e.valueOf()) / 36e5
                                    );
                                })(e, t)),
                                lt(n) ? { unit: "hour", value: n } :
                                ((n = (function(e, t) {
                                        return (
                                            (t.valueOf() - e.valueOf()) /
                                            6e4
        ...
        format(e, t, n = {}) {
            return t.format({
                    ...
                    timeZoneOffset: null != n.forcedTzo ?
                        n.forcedTzo : this.offsetForMarker(e),
                },
                this
            );
        }
    ...
    function Ki(e, t) {
        return yn(!e || t > 10 ? { weekday: "short" } :
            t > 1 ? {
                weekday: "short",
                month: "numeric",
                day: "numeric",
    ...
    class ns extends Xr {
        ...
        render() {
            const { props: e, context: t } = this, { options: n } = t, { customGenerator: r, defaultGenerator: i, renderProps: s } = e,
            o = is(e);
            let a,
                l,
                c = !1,
        ...
        triggerCustomRendering(e) {
            var t;
            const { props: n, context: r } = this, { handleCustomRendering: i, customRenderingMetaMap: s } =
            r.options;
            if (i) {
                const r =
    ...
    class cs extends Xr {
        render() {
            let { dateEnv: e, options: t, theme: n, viewApi: r } = this.context, { props: i } = this, { date: s, dateProfile: o } = i,
                ...
                u = Object.assign(
                    Object.assign(
                        Object.assign({ date: e.toDate(s), view: r },
                            i.extraRenderProps
                        ), { text: c }
                    ),
                    a
            ...
            return p(
                ...
                (e) =>
                p(
                    "div", { className: "fc-scrollgrid-sync-inner" }, !a.isDisabled &&
                    p(e, {
                        elTag: "a",
                        elAttrs: d,
                        elClasses: [
        ...
        render() {
            ...
            return p(
                as, {
                    ...
                    elAttrs: Object.assign({ role: "columnheader", colSpan: e.colSpan },
                        e.extraDataAttrs
                    ),
                    renderProps: l,
                    generatorName: "dayHeaderContent",
    ...
    class vs {
        constructor(e, t) {
            ...
            if (t) {
                for (
                    r = s[0].getUTCDay(), n = 1; n < s.length && s[n].getUTCDay() !== r; n += 1
                );
    ...
    class ys {
        ...
        sliceNowDate(e, t, n, r, ...i) {
            return this._sliceDateSpan({ range: { start: e, end: Ht(e, 1) }, allDay: !1 },
                t,
                n, {},
                r,
                ...i
                ...
                !(function(e, t, n, r) {
                    let i = t.getCurrentData(),
                        ...
                        c = pi(
                            a,
                            s.isEvent ?
                            e.eventUiBases : { "": i.selectionConfig }
                        );
                    r && (c = Dt(c, r));
                    let d =
                        ((g = e.eventStore),
                    ...
                    for (let r in l) {
                        ...
                        for (let e of p.allows) {
                            let i,
                                ...
                                l = b.instances[r];
                            if (
                                ((i = a ? new li(t, a, l) : new li(t, m)), !e(ni(s, t), i))
                            )
                                return !1;
                        }
                    }
    ...
    class Bs extends Xr {
        ...
        render() {
            let { props: e } = this, { liquid: t, liquidIsAbsolute: n } = e,
            r = t && n,
                i = ["fc-scroller"];
            return (
                t &&
        ...
        needsXScrolling() {
            ...
            t =
                ...
                this.getYScrollbarWidth(), { children: n } = e;
            for (let e = 0; e < n.length; e += 1) {
        ...
        needsYScrolling() {
            ...
            t =
                ...
                this.getXScrollbarWidth(), { children: n } = e;
            for (let e = 0; e < n.length; e += 1) {
    ...
    class Ks extends Xr {
        ...
        render() {
            const { props: e, context: t } = this, { options: n } = t, { seg: r } = e, { eventRange: i } = r, { ui: s } = i,
            o = {
    ...
    function oo(e) {
        ...
        return Object.assign(
            Object.assign(
                Object.assign({ date: n.toDate(t), view: e.viewApi }, s), { isMonthStart: i, dayNumberText: o }
            ),
            e.extraRenderProps
        );
    }
    ...
    const uo = (e) =>
        p(qr.Consumer, null, (t) => {
            let { dateEnv: n, options: r } = t, { date: i } = e,
        ...
        render() {
            ...
            return fe(
                p(
                    ...
                    p(
                        "div", {
                            className: "fc-popover-header " +
                                e.getClass("popoverHeader"),
                        },
                        p(
                            "span", { className: "fc-popover-title", id: r.titleId },
                            n.title
                        ),
                        p("span", {
    ...
    class go extends Jr {
        ...
        render() {
            let { options: e, dateEnv: t } = this.context, { props: n } = this, { startDate: r, todayRange: i, dateProfile: s } = n,
    ...
    class po extends Xr {
        constructor() {
            super(...arguments),
                ...
                (this.handleClick = (e) => {
                    let { props: t, context: n } = this, { moreLinkClick: r } = n.options,
                        i = vo(t).start;
        ...
        render() {
            ...
            return p(qr.Consumer, null, (n) => {
                let { viewApi: r, options: i, calendarApi: s } = n, { moreLinkText: o } = i, { moreCnt: a } = e,
                l = vo(e),
                    ...
                    p(
                        go, {
                            ...
                            alignmentEl: e.alignmentElRef ?
                                e.alignmentElRef.current : this.linkEl,
    ...
    class Ro {
        ...
        getUnitViewSpec(e) {
            let t,
                n, { viewSpecs: r, toolbarConfig: i } = this.getCurrentData(),
                s = [].concat(
    ...
    function Po(e) {
        return {
            ...
            premiumReleaseDate: e.premiumReleaseDate ?
                new Date(e.premiumReleaseDate) : void 0,
            deps: e.deps || [],
            reducers: e.reducers || [],
                        ...
                        void 0 === a ?
                            ((n[e] = o.id),
                                ...
                                (r = {
                                    ...
                                    namedTimeZonedImpl: s.namedTimeZonedImpl ||
    ...
    function Wo(e) {
        ...
        return (
            ...
            (n = Lo(Object.assign(Object.assign({}, t), { content: n }))), { superType: t.type, component: n, rawOptions: t }
        );
    }
    ...
    function $o(e, t, n, r) {
        ...
        o = r.pluginHooks.eventSourceDefs[e.sourceDefId],
            a = Ye();
        return (
            o.fetch({ eventSource: e, range: t, isRefetch: n, context: r },
                (n) => {
                    let { rawEvents: o } = n;
                    ...
                    if (
                        ...
                        let i,
                            s = {
                                ...
                                endRecur: e.endRecur ?
                                    t.createMarker(e.endRecur) : null,
                            };
                        return (
                            e.duration && (i = e.duration), !i &&
                            e.startTime &&
                            e.endTime &&
                            ((n = e.endTime),
                                (r = e.startTime),
            ...
            propSetHandlers: {
                dateProfile: function(e, t) {
                    t.emitter.trigger(
                        "datesSet",
                        Object.assign(
                            Object.assign({}, ki(e.activeRange, t.dateEnv)), { view: t.viewApi }
                        )
                    );
                },
        ...
        drain() {
            ...
            for (; e.length;) {
                let t,
                    n = [];
                for (;
                    (t = e.shift());) this.runTask(t), n.push(t);
                this.drained(n);
            }
        }
        runTask(e) {
    ...
    class Da extends Xr {
        ...
        renderWidgetGroup(e) {
            let { props: t } = this, { theme: n } = this.context,
                r = [],
                i = !0;
            for (let s of e) {
                let {
            ...
            if (r.length > 1) {
                return p(
                    "div", { className: (i && n.getClass("buttonGroup")) || "" },
                    ...r
                );
            }
            return r[0];
    ...
    class wa extends Xr {
        render() {
            let e,
                t, { model: n, extraClassName: r } = this.props,
                i = !1,
                s = n.sectionWidgets,
                o = s.center;
            return (
        ...
        constructor(e) {
            super(e),
                (this.handleSegClick = (e, t) => {
                    let { component: n } = this, { context: r } = n,
                    i = gi(t);
    ...
    class xa extends Gi {
        ...
        triggerEvent(e, t, n) {
            let { component: r } = this, { context: i } = r,
            s = gi(n);
    ...
    class _a extends Zr {
                ...
                (this.registerInteractiveComponent = (e, t) => {
                    let n = (function(e, t) {
                            return {
                                component: e,
                                el: t.el,
                                useEventCenter: null == t.useEventCenter ||
                                    t.useEventCenter,
        ...
        render() {
            ...
            return p(
                ...
                p(
                    Ca, { liquid: s, height: o, aspectRatio: e, labeledById: l },
                    this.renderView(t),
        ...
        renderView(e) {
            let { pluginHooks: t } = e, { viewSpec: n } = e,
            r = {
                    dateProfile: e.dateProfile,
    ...
    function Ma(e) {
        ...
        return new Bi(
            Object.assign(
                Object.assign({ timeZone: En.timeZone, calendarSystem: "gregory" },
                    e
                ), { locale: t }
            )
        );
    ...
    class Pa {
        ...
        tryStart(e) {
            let t = this.querySubjectEl(e),
                n = e.target;
            return (!(!t || (this.handleSelector && !Ie(n, this.handleSelector))) &&
                ((this.subjectEl = t),
                    (this.isDragging = !0),
    ...
    class La {
        ...
        handleSide(e, t) {
            let { scrollCache: n } = e, { edgeThreshold: r } = this,
            i = r - e.distance,
            ...
            super(e),
                ...
                (this.onPointerMove = (e) => {
                    if (this.isInteracting) {
                        if (
                            (this.emitter.trigger("pointermove", e), !this.isDistanceSurpassed)
                        ) {
                            let t,
                                n = this.minDistance,
                                { deltaX: r, deltaY: i } = e;
    ...
    class Za extends Gi {
        constructor(e) {
                ...
                (this.handleHitUpdate = (e, t) => {
                    ...
                    this.displayDrag(s, c),
                        ...
                        (i === s && qa(r, e) && (o = null),
                            ...
                            this.dragging.setMirrorIsVisible(!e ||
                                !this.subjectEl
                                .getRootNode()
            ...
            let { component: t } = this, { options: n } = t.context,
        ...
        componentInteractions: [
            ...
            class extends Gi {
                constructor(e) {
                    ...
                    let { component: t } = e, { options: n } = t.context,
                        r = (this.dragging = new Fa(e.el));
                    (r.touchScrollAllowed = !1),
                ...
                constructor(e) {
                    super(e),
                        ...
                        (this.handlePointerDown = (e) => {
                            ...
                            this.dragging.setIgnoreMove(!this.component.isValidSegDownEl(
                                    e.origEvent.target
                                ) ||
                                (e.isTouch &&
            ...
            class {
                constructor(e) {
                    ...
                    (this.onDocumentPointerUp = (e) => {
                        let { context: t } = this, { documentPointer: n } = this,
                        r = t.getCurrentData();
                        if (!n.wasTouchScroll) {
                            if (
                                r.dateSelection &&
    ...
    class cl extends Xr {
        ...
        render() {
            let { props: e } = this, { allSegs: t, invisibleSegs: n } = this.compileSegs(
                e.singlePlacements
            );
            return p(po, {
    ...
    class hl extends Jr {
        ...
        render() {
            let { context: e, props: t, state: n, rootElRef: r } = this, { options: i, dateEnv: s } = e, { date: o, dateProfile: a } = t;
            const l =
                t.showDayNumber &&
                (function(e, t, n) {
                ...
                p(
                    ...
                    p(
                        ...
                        p(s, {
                            ...
                            elAttrs: Object.assign(
                                Object.assign({}, Cr(e, o)), { id: n.dayNumberId }
                            ),
                        })
                    ) :
                    t.showDayNumber ?
    ...
    class vl extends Jr {
        ...
        render() {
            let { props: e, state: t, context: n } = this, { options: r } = n,
            i = e.cells.length,
        ...
        renderFgSegs(e, t, n, r, i, s, o) {
            ...
            if (c)
                for (let f of t) {
                    let { seg: t } = f, { instanceId: g } = t.eventRange.instance,
                        m = g + ":" + e,
                        v = f.isVisible && !r[g],
                        y = f.isAbsolute,
                        b = "",
                        ...
                        h.push(
                            p(
                                "div", {
                                    ...
                                    key: m,
                                    ref: u ?
                                        null : this.segHarnessRefs.createRef(m),
                                    style: {
                                        visibility: v ? "" : "hidden",
        ...
        renderFillSegs(e, t) {
            let { isRtl: n } = this.context, { todayRange: r } = this.props, { framePositions: i } = this.state,
                s = [];
            if (i)
                for (let o of e) {
                    let e = n ? {
    ...
    class yl extends Jr {
        ...
        prepareHits() {
            (this.rowPositions = new Br(
                this.rootEl,
                this.rowRefs.collect().map((e) => e.getCellEls()[0]), !1, !0
            )),
        ...
        queryHit(e, t) {
            ...
            if (null != s && null != i) {
                ...
                return {
                    ...
                    dateSpan: Object.assign({ range: this.getCellRange(s, i), allDay: !0 },
                        e.extraDateSpan
                    ),
    ...
    class El extends Jr {
        ...
        render() {
            let { props: e } = this, { dayMaxEventRows: t, dayMaxEvents: n, expandRows: r } = e,
            i = !0 === n || !0 === t;
    ...
    class Al extends Jr {
        ...
        render() {
            ...
            return p(
                El,
                Object.assign({ ref: this.tableRef },
    ...
    class Cl extends Jr {
        ...
        renderSimpleLayout(e, t) {
            ...
            return (
                ...
                p(
                    So, { elClasses: ["fc-daygrid"], viewSpec: r.viewSpec },
                    p(Js, {
        ...
        renderHScrollLayout(e, t, n, r) {
            ...
            return (
                ...
                p(
                    So, { elClasses: ["fc-daygrid"], viewSpec: o.viewSpec },
                    p(i, {
    ...
    class _l extends hr {
        ...
        getKeysForEventDef(e) {
            return e.allDay ?
                hi(e) ? ["timed", "allDay"] : ["allDay"] : ["timed"];
        }
    }
    const Tl = yn({
        hour: "numeric",
    ...
    class Nl extends Jr {
        constructor() {
            super(...arguments),
                ...
                (this.renderHeadAxis = (e, t = "") => {
                    let { options: n } = this.context, { dateProfile: r } = this.props,
                        i = r.renderRange,
                        s =
                        1 === jt(i.start, i.end) ?
        ...
        getAllDayMaxEventProps() {
            ...
            return (
                (!0 !== e && !0 !== t) || ((e = void 0), (t = 5)), { dayMaxEvents: e, dayMaxEventRows: t }
            );
        }
    }
    ...
    class Hl {
        ...
        computeTimeTop(e) {
            let t,
                n, { positions: r, dateProfile: i } = this,
                s = r.els.length,
                o =
        ...
        render() {
            ...
            return p(
                ...
                e.slatMetas.map((i, s) => {
                    ...
                    return p(
                        "tr", { key: i.key, ref: r.createRef(i.key) },
                        e.axis && p(kl, Object.assign({}, i)),
                        p(as, {
                            elTag: "td",
                            elClasses: [
                                "fc-timegrid-slot",
                                "fc-timegrid-slot-lane", !i.isLabeled && "fc-timegrid-slot-minor",
                            ],
    ...
    class $l extends Xr {
        ...
        render() {
            ...
            return p(
                io, {
                    ...
                    elAttrs: Object.assign({ role: "gridcell" },
                        e.extraDataAttrs
                    ),
                    date: e.date,
                    dateProfile: e.dateProfile,
        ...
        renderPositionedFgSegs(e, t, n, r, i, s) {
            let {
                ...
                m = n || r || i,
                v = Yl(e, d, u, c), { segPlacements: b, hiddenGroups: E } = (function(e, t, n, r) {
                    let i = [],
                        s = [];
                    for (let n = 0; n < e.length; n += 1) {
                        let r = t[n];
            ...
            return p(
                ...
                b.map((e) => {
                    ...
                    c = o.eventRange.instance.instanceId,
                        ...
                        u = Kl(l && l.span),
                        v = !m && l ?
                        this.computeSegHStyle(l) : { left: 0, right: 0 },
                    ...
                    return p(
                        "div", {
                            ...
                            key: s || c,
                            style: Object.assign(
                                Object.assign({ visibility: d ? "" : "hidden" },
                                    u
                                ),
                                v
                            ),
        ...
        computeSegHStyle(e) {
            let t,
                n, { isRtl: r, options: i } = this.context,
    ...
    function Jl(
        ...
        return p(
            ...
            e.map((e) => {
                ...
                return p(
                    "div", { key: i, style: { visibility: o[i] ? "hidden" : "" } },
                    p(
                        Xl,
                        Object.assign({
                                seg: e,
    ...
    class tc extends Jr {
        ...
        queryHit(e, t) {
            let { dateEnv: n, options: r } = this.context, { colCoords: i } = this, { dateProfile: s } = this.props, { slatCoords: o } = this.state, { snapDuration: a, snapsPerSlot: l } = this.processSlotOptions(
            ...
            if (null != c && null != d) {
                ...
                return {
                    dateProfile: s,
                    dateSpan: Object.assign({ range: { start: m, end: v }, allDay: !1 },
                        e.extraDateSpan
                    ),
                    dayEl: i.els[c],
                    rect: {
    ...
    class ic extends Jr {
        ...
        render() {
            let { props: e, context: t } = this, { dateProfile: n, dayTableModel: r } = e, { nowIndicator: i, nextDayThreshold: s } = t.options,
            ...
            timeGrid: {
                component: class extends Nl {
                    ...
                    render() {
                        ...
                        } = this.context, { props: r } = this, { dateProfile: i } = r,
    ...
    class dc extends Xr {
        ...
        render() {
            let { theme: e, dateEnv: t, options: n, viewApi: r } = this.context, { cellId: i, dayDate: s, todayRange: o } = this.props, { textId: a } = this.state,
                l = Sr(s, o),
    ...
    function uc(e) {
        return p(
            ...
            p(
                "a",
                Object.assign({ id: e.textId, className: "fc-list-day-text" },
                    e.navLinkAttrs
                ),
                e.text
            ),
        ...
        views: {
            list: {
                component: class extends Jr {
                    ...
                    render() {
                        let { props: e, context: t } = this, { dayDates: n, dayRanges: r } =
                        ...
                        return p(
                            So, {
                                ...
                                elClasses: [
                                    "fc-list",
                                    t.theme.getClass("table"), !1 !== t.options.stickyHeaderDates ?
                                    "fc-list-sticky" :
                                    "",
                                ],
                                viewSpec: t.viewSpec,
        ...
        render() {
            ...
            return p(
                ...
                p(
                    ...
                    p(
                        "div", { className: "fc-multimonth-title", id: t.labelId },
                        n.dateEnv.format(
                ...
                p(
                    "div", {
                        className: [
                            ...
                            "fc-daygrid",
                            "fc-daygrid-body", !i && "fc-daygrid-body-balanced",
        ...
        views: {
            multiMonth: {
                component: class extends Jr {
                    ...
                    render() {
                        const { context: e, props: t, state: n } = this, { options: r } = e, { clientWidth: i, clientHeight: s } = n,
                        o = n.monthHPadding || 0,
                            a =
                            Math.min(
                                null != i ?
